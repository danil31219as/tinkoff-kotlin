...
class SQLDialect : Dialect() {
    ...
    init {
        ...
        registerFunction("concat",
            VarArgsSQLFunction(StringType.INSTANCE, "", "||", ""))
        registerFunction("mod",
            SQLFunctionTemplate(StringType.INSTANCE, "?1 % ?2"))
        registerFunction("substr",
            StandardSQLFunction("substr", StringType.INSTANCE))
...
class SQLiteIdentityColumnSupport :
    ...
    override fun getIdentitySelectString(
        table: String,
        column: String,
        type: Int,
    ): String {
